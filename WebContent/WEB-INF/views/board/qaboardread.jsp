		...
		<div class="card shadow mx-auto mt-5" style="width: 70rem;">
			<div class="card-body">
				...
				<table class="table">
					<tr>
						<th width="100">제목</th>
						<td width="500">${qabean.subject }</td>
					<tr>
						<th width="100">작성자</th>
						<td width="500">${qabean.u_id }</td>
					<tr>
						<th width="100">작성일</th>
						<td width="700">${qabean.writedate }</td>
					<tr>
						<th width="100">내용</th>
						<td width="700">${qabean.content }</td>
				</table>

				<div class="form-group text-right">
					<a href="qaboardlist" class="btn btn-primary">목록</a> 
					
				<button type="button" onclick="window.open('qaboardcomment?ref=${qabean.ref}&step=${qabean.step}&bolevel=${qabean.bolevel}','qaboardwrite', 'width=550, height=600 scrollbars=yes');" class="btn btn-warning">답변</a>
