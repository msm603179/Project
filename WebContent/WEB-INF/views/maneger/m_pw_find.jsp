...
<title>Insert title here</title>
    ...
    <h1>비밀번호찾기</h1>
    <fo:form action="m_pw_findrun" modelAttribute="pc_maneger" method="post" >
    ...
    <tr>
        <td><span>아이디</span></td>
        <td colspan="3"><fo:input type="text" class="find_id" path="m_id"/></td>
         <td><fo:errors path="m_id" cssClass="errorText" /></td>
    </tr>
    <tr>
